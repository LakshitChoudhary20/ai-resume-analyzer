/**
 * ATS Score Calculator — realistic scoring
 * Average resume: 55–70 | Good resume: 70–85 | Exceptional: 88+
 */
...
const calculateATSScore = (resumeText, skills, jdSkills = []) => {
  ...
  // 2. Sections (15 pts) — need core sections
  ...
  // 5. Quantified achievements (15 pts) — biggest differentiator
